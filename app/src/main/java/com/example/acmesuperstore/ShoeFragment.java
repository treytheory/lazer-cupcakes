...
public class ShoeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.shoe_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast myShoe = Toast.makeText(getActivity(), "Nike - $199.99 - added to your cart", Toast.LENGTH_SHORT);
                myShoe.show();
            }
        });
    }
