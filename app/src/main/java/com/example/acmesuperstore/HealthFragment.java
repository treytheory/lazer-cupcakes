...
public class HealthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.health_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast myHealth = Toast.makeText(getActivity(), "Purell - $4.99 - added to your cart", Toast.LENGTH_SHORT);
                myHealth.show();
            }
        });
    }
