...
public class ClothesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.clothes_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast myClothes = Toast.makeText(getActivity(), "Puma - $59.99 - added to your cart", Toast.LENGTH_SHORT);
                myClothes.show();
            }
        });
    }
